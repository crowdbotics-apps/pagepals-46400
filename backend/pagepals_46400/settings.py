"""
Django settings for pagepals_46400 project.
...
ROOT_URLCONF = 'pagepals_46400.urls'
...
WSGI_APPLICATION = 'pagepals_46400.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pagepals_46400 API",
    "DESCRIPTION": "API documentation for pagepals_46400 App",
    "VERSION": "v1",
}
